...
export const app = {
  ...
  menu: [
    ...
    // { name: "booking", uid: shortid.generate(), notification: 0 ,isHome: false, },
    // { name: "accessories", uid: shortid.generate(), notification: 0 ,isHome: false, },
    // { name: "checkout", uid: shortid.generate(), notification: 0 ,isHome: false, },
    { name: "Financing", uid: shortid.generate(), notification: 0, isHome: false },
    { name: "Login", uid: shortid.generate(), notification: 0, isHome: false },
  ],
  gallery: {
